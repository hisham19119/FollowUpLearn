    ...
    <div className='q-container'>
      {!result ? (
        <div className='q-wrapper'>
          ...
          <button className='q-btn'  style={{background:"#8e3257"}} onClick={handleNext} disabled={!isAnsSelected}>
        ...
        <div className='r-wrapper'>
          ...
          {percentageRightAnswers >= 50 ? (
            <a className='r-link'  > 
            <button className='.q-btn' onClick={handleCertificate} style={{direction:"rtl"}}>
                        احصل على الشهادة
            </button>
            </a>
          ) : (
